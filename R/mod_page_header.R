...
mod_page_header_ui <- function(id = character(), i18n = character()){
  ...
  command_bar_1 <- div(
    ...
    shiny.fluent::CommandBar(
      items = list(
        # Configure
        shiny.fluent::CommandBarItem(key = "", text = shiny.fluent::FontIcon(iconName = "Settings"),
        ...
        # Develop
        shiny.fluent::CommandBarItem(key = "", text = shiny.fluent::FontIcon(iconName = "CodeEdit"),
          subMenuProps = list(items = list(
        ...
        # Discover
        shiny.fluent::CommandBarItem(key = "", text = shiny.fluent::FontIcon(iconName = "World"), title = i18n$t("explore"), href = shiny.router::route_link("explore"))
      )
    ),
    ...
    shiny.fluent::CommandBar(
      items = list(
        shiny.fluent::CommandBarItem(
          key = "", text = shiny.fluent::FontIcon(iconName = "Settings"),
          subMenuProps = list(items = list(
    ...
    div(
      ...
      shiny.fluent::CommandBar(
        items = list(
          # Explore
          shiny.fluent::CommandBarItem(
            key = "", text = shiny.fluent::FontIcon(iconName = "BIDashboard"),
            subMenuProps = list(items = list(
          ...
          # Messages
          shiny.fluent::CommandBarItem(key = "", text = shiny.fluent::FontIcon(iconName = "Chat"), href = shiny.router::route_link("project_messages"), title = i18n$t("messages")),
          # Console
          shiny.fluent::CommandBarItem(key = "",text = shiny.fluent::FontIcon(iconName = "Code"), href = shiny.router::route_link("project_console"), title = i18n$t("console")),
          # Tasks
          shiny.fluent::CommandBarItem(key = "", text = shiny.fluent::FontIcon(iconName = "CheckList"), href = shiny.router::route_link("tasks"), title = i18n$t("tasks"))
        )
      ),
      class = "header_command_bar",
