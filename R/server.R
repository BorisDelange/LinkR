...
app_server <- function(language = "en", languages = tibble::tibble(), i18n = character(), app_folder = character(), 
  ...
  function(input, output, session ) {
    ...
    if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - init"))
    
    language <- tolower(language)
    
    if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - reactive values"))
    ...
    # App folder
    if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - app_folder"))
    ...
    if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - translations"))
    ...
    if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - app_db"))
    ...
    onStop(function() {
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - observer onStop"))
    ...
    observeEvent(r$db, {
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - observer r$db"))
    ...
    observeEvent(r$user_id, {
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - observer r$user_id"))
      ...
      # Clear temp dir
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - clear temp_files"))
    ...
    # Route pages
    if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - shiny.router"))
    ...
    observeEvent(r$user_accesses, {
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - observer r$user_accesses"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs"))
      if (perf_monitoring) monitor_perf(r = r, action = "start")

      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - home"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - data"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - my_studies / my_subsets / vocabularies / scripts"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - messages"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - plugins"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - general_settings"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - settings_app_db"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - settings_git"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - settings_users"))
      ...
      mod_page_header_server("settings_users", r, language, i18n, perf_monitoring, debug)
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - settings_dev"))
      ...
      # if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - data_sources / datasets / vocabularies"))
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - datasets / vocabularies"))
      ...
      sapply(c("datasets", "vocabularies"), function(page){
        ...
        mod_page_header_server(paste0("settings_", page), r, language, i18n, perf_monitoring, debug)
        if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("server - load server tabs - ", page))
      })

      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - settings_log"))
      ...
      if (debug) cat(paste0("\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), " - server - load server tabs - end"))
