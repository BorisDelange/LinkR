...
linkr <- function(
  ...
  if (debug) cat(paste0(now(), " - linkr - init - v0.3.0.9009"))
  ...
  sub_dirs <- c("app_database", "datasets", "datasets_files", "messages", "plugins", "studies", "studies_files", "scripts", "temp_files", "translations", "vocabularies", "log")
