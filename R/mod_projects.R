      ...
      div(
        ...
        div(
          ...
          div(
            ...
            div(
              id = ns("explore_data_div"),
              h1(i18n$t("explore_data")),
              div(
                div(
                  div(
                    tags$i(class = "fas fa-user", style = "font-size: 2rem; color: white; margin-bottom: 12px;")
                  ),
                ...
                div(
                  div(
                    tags$i(class = "fas fa-users", style = "font-size: 2rem; color: white; margin-bottom: 12px;")
                  ),
