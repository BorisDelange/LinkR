...
mod_app_db_server <- function(id = character(), r = shiny::reactiveValues(), m = shiny::reactiveValues(), i18n = character(),
  ...
  moduleServer(id, function(input, output, session){
    ...
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer r$db_database"))
    ...
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer input$db_connection_save"))
    #   
    ...
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "start")
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer r$reload_app_db_tables"))
    #   
    ...
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_app_db - observer r$reload_app_db_tables"))
    # })
    # 
    # # --- --- --- ---
    # # DB request ----
    ...
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer input$request"))
    #   
    ...
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer input$app_db_request_code_run_selection"))
    #   
    ...
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer input$app_db_request_code_run_all"))
    #   
    #   r$app_db_request_code <- input$app_db_request_code
    #   r$app_db_request_trigger_code <- now()
    # })
    ...
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "start")
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer r$app_db_request_trigger_code"))
    #     
    #   # Replace \r with \n to prevent bugs
    ...
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_app_db - observer r$app_db_request_trigger_code"))
    # })
    # 
    # # --- --- --- --
    # # Export DB ----
    ...
    #   
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer r$options"))
    #   
    ...
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "start")
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer input$db_save_button"))
    #   
    ...
    #   }
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_app_db - observer input$db_save_button"))
    #   
    # })
    # 
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_app_db - output$db_save"))
    #   }
    # )
    # 
    # # --- --- --- --- --- -
    ...
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - output$db_restore_status"))
    #   
    ...
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "start")
    #   if (debug) cat(paste0("\n", now(), " - mod_app_db - observer input$db_restore_button"))
    #   
    ...
    #   
    #   if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_app_db - observer input$db_restore_button"))
    # })
