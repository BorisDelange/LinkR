#' @noRd
mod_users_ui <- function(id = character(), language = "en", languages = tibble::tibble(), i18n = character(), users_accesses_toggles_options = tibble::tibble()){
  ns <- NS(id)
...
#' @noRd 
mod_users_server <- function(id = character(), r = shiny::reactiveValues(), d = shiny::reactiveValues(), m = shiny::reactiveValues(), i18n = character(), language = "en", debug = FALSE, users_accesses_toggles_options = tibble::tibble()){
  moduleServer(id, function(input, output, session){
    ...
    #     
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer r$users_accesses"))
    #       
    ...
    #     
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer r$user_accesses"))
    #     
    ...
    #   if (debug) cat(paste0("\n", now(), " - mod_users - ", id, " - observer shiny_router::change_page"))
    # 
    ...
    #         
    #         if (debug) cat(paste0("\n", now(), " - mod_users - observer r$users_[accesses/statuses]"))
    #         
    ...
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$add"))
    #     
    #     # If user has access
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer input$add"))
    #   })
    # }
    # 
    # # --- --- --- --- --- ---
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer r$..[table]"))
    #     
    #     r[[paste0(table, "_temp")]] <- r[[table]] %>% dplyr::mutate(modified = FALSE)
    #     
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer r$..[table]"))
    #   })
    # }
    # 
    # # --- --- --- --- --- --- --- --
    ...
    #     
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$management_datatable_cell_edit"))
    #     
    ...
    #       
    #       if (perf_monitoring) monitor_perf(r = r, action = "start")
    #       if (debug) cat(paste0("\n", now(), " - mod_users - observer r$users"))
    #       
    #       update_settings_datatable(input = input, tab_id = id, r = r, ns = ns, table = table, dropdowns = dropdowns, i18n = i18n)
    #       
    #       if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer r$users"))
    #     })
    #   }
    # 
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$management_save"))
    #     
    #     save_settings_datatable_updates(output = output, r = r, ns = ns, table = table, i18n = i18n, r_message_bar = TRUE)
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer input$management_save"))
    #   })
    # }
    # 
    # # --- --- --- --- --- --- --- --
    ...
    #     
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$deleted_pressed"))
    #     
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$delete_selection"))
    #     
    ...
    #     
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$options"))
    #     
    #     # Show options toggle
    ...
    #     
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer r$users_statuses_options"))
    # 
    #     options <- convert_tibble_to_list(r$users_accesses %>% dplyr::arrange(name), key_col = "id", text_col = "name")
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$options_selected"))
    # 
    ...
    # 
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer input$options_selected"))
    #   })
    # 
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$select_all"))
    # 
    #     req(input$options_selected)
    #     r$reload_all_users_accesses_toggles <- now()
    #     r$reload_all_users_accesses_toggles_value <- TRUE
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer input$select_all"))
    #   })
    # 
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$unselect_all"))
    #     
    #     req(input$options_selected)
    #     r$reload_all_users_accesses_toggles <- now()
    #     r$reload_all_users_accesses_toggles_value <- FALSE
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer input$unselect_all"))
    #   })
    #   
    #   observeEvent(r$reload_all_users_accesses_toggles, {
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer r$reload_all_users_accesses_toggles"))
    #     
    ...
    #     }
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer r$reload_all_users_accesses_toggles"))
    #   })
    # 
    #   # When save button is clicked
    ...
    #     
    #     if (perf_monitoring) monitor_perf(r = r, action = "start")
    #     if (debug) cat(paste0("\n", now(), " - mod_users - observer input$options_save"))
    # 
    #     req(input$options_selected)
    #     if (length(input$options_selected) > 1) link_id <- input$options_selected$key
    #     else link_id <- input$options_selected
    ...
    # 
    #     if (perf_monitoring) monitor_perf(r = r, action = "stop", task = paste0("mod_users - observer input$options_save"))
    #   })
    # }
